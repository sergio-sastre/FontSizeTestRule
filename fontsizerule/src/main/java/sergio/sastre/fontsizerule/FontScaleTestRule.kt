...
class FontScaleTestRule(private val fontScaleSetting: FontScaleSetting, private val fontScale: FontScale) : TestWatcher(), TestRule {
    ...
    private class FontScaleStatement internal constructor(private val baseStatement: Statement, private val scaleSetting: FontScaleSetting, private val scale: FontScale) : Statement() {
